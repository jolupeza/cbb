...
class Joblevel
{
    ...
    {
        $labels = array(
            'name' => _x('Áreas', 'Taxonomy plural name', $this->domain),
            'singular_name' => _x('Área', 'Taxonomy singular name', $this->domain),
            'search_items' => __('Buscar Área', $this->domain),
            'popular_items' => __('Áreas Populares', $this->domain),
            'all_items' => __('Todos las Áreas', $this->domain),
            'parent_item' => __('Área Padre', $this->domain),
            'parent_item_colon' => __('Área Padre', $this->domain),
            'edit_item' => __('Editar Área', $this->domain),
            'update_item' => __('Actualizar Área', $this->domain),
            'add_new_item' => __('Añadir nueva Área', $this->domain),
            'new_item_name' => __('Nueva Área', $this->domain),
            'add_or_remove_items' => __('Añadir o eliminar Área', $this->domain),
            'choose_from_most_used' => __('Choose from most used text-domain', $this->domain),
            'menu_name' => __('Áreas', $this->domain),
        );
