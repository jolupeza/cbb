 ...
 * plugin.
 *
 * @package VM_Manager\Inc
 */
spl_autoload_register('vm_manager_namespace_autoload');
 ...
 */
function vm_manager_namespace_autoload($class_name) {
    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos($class_name, 'CBB_WorkWithUs')) {
        return;
    }
