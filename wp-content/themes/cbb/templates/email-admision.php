...
<head>
  ...
  .bodycopy, .legendcopy {font-size: 14px; line-height: 18px;}
  .legendcopy { font-family: Arial, color: #ffffff; }
...
<body yahoo bgcolor="#b00725" style="margin: 0; padding: 0; min-width: 100% !important;">
<table width="100%" bgcolor="#b00725" border="0" cellpadding="0" cellspacing="0">
<tr>
  <td>
    <!--[if (gte mso 9)|(IE)]>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 600px; background-color: #ffffff;">
      <tr>
        <td bgcolor="#b00725" class="header" style="padding: 40px 30px 20px 30px;">
      ...
      <tr>
        <td bgcolor="#b00725" class="innerpadding" style="padding: 30px 50px 30px 50px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="lengendcopy" align="left" style="color: #ffffff; font-family: Arial; font-size: 14px; line-height: 18px;">
      ...
      <tr>
        <td class="innerpadding bodycontent" style="padding: 30px 50px 30px 50px; background-color: #f7f7f7;">
          <table width="160" align="left" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="bodycopy" align="right" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial; font-weight: bold;">D.N.I. / C.E.:</td>
            </tr>
            <tr>
              <td class="bodycopy" align="right" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial; font-weight: bold;">Teléfono / Celular:</td>
            </tr>
            <tr>
