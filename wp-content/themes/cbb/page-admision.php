...
<?php else : ?>
  <?php
    ...
    if ($the_query->have_posts()) :
      $i = 0;
  ?>
    <section id="carousel-admision" class="carousel slide Carousel Carousel--home" data-ride="carousel">
      ...
      <button class="Arrow js-move-scroll" data-href="proceso-de-matricula">ir abajo <i class="glyphicon glyphicon-chevron-down"></i></button>
